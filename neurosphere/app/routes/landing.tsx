      ...
      <header className="sticky top-0 z-10 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <nav className="flex items-center gap-3">
            <Link to="/sign-in" className={cn(buttonVariants({ variant: "ghost" }), "font-medium transition-all hover:scale-105")}>
              Sign In
            </Link>
            <Link to="/sign-up" className={cn(buttonVariants(), "font-medium transition-all hover:scale-105")}>
              Get Started
            </Link>
          </nav>
        </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link to="/sign-up" className={cn(buttonVariants({ size: "lg" }), "w-full transition-all hover:scale-105 hover:shadow-md")}>
                  Get Started
                </Link>
                <Link to="#learn-more" className={cn(buttonVariants({ variant: "outline", size: "lg" }), "w-full transition-all hover:scale-105 hover:bg-muted")}>
                  Learn More
                </Link>
              </div>
            </div>
            <div className="hidden lg:flex items-center justify-center">
              <div className="relative aspect-square w-full max-w-[500px] overflow-hidden rounded-lg bg-muted transition-all hover:shadow-xl">
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
            {features.map((feature, index) => (
              <div 
                key={index} 
                className="flex flex-col items-center space-y-2 rounded-lg border p-6 transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:bg-accent/40 hover:-translate-y-1"
              >
                <div className="p-2 bg-muted rounded-full transition-colors group-hover:bg-primary/20">
                  {feature.icon}
                </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="flex items-center gap-2">
              <Link to="/" className="text-lg font-bold transition-colors hover:text-primary">Neurosphere</Link>
            </div>
